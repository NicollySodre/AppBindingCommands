...
namespace AppBindingCommands.ViewModels
{
    public class UsuarioViewModel : INotifyPropertyChanged
    {
        ...
        void OnPropertyChangeed(string propertyName)
        {
        ...
        public string Name
        {
            ...
            set
            {
                ...
                name = value;
                OnPropertyChangeed(nameof(name));
                OnPropertyChangeed(nameof(DisplayName));
            }
        }
        ...
        public string DisplayMessage { 
            ...
            set 
            {
                ...
                OnPropertyChangeed(nameof(DisplayMessage));
            }
        }
        ...
        public async Task CleanConfirmation()
        {
                ...
                .DisplayAlert("Confirmação", "Confirma limpeza de dados?", "Yes", "No"))
            {
                ...
                OnPropertyChangeed(Name);
                OnPropertyChangeed(DisplayMessage);
